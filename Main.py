...
def editCustDetails(UserDetails):
    ...
    def getInputScreen(Label, validationFunction, updateKey):
        ...
        while active:
            ...
            MessageSurface = Font.render(message, True, MessageColour)
            Screen.blit(MessageSurface, (Width // 2, 400))

            EnterButton = Button("Enter", (Width // 2 - 60, Height - 200, 120, 40), (64, 64, 64), (255, 255, 255), None)
    ...
    def validatePasswordField(InputText):
        return (len(InputText) >= 8 and any(c.isdigit() for c in InputText) 
                and 
                any(c.isupper() for c in InputText), 
